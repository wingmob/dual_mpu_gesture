...
from ...common.single_protocol import load_recording


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train a single-MPU gesture classifier from labeled CSV trials.")
    parser.add_argument("--data-dir", type=Path, default=Path("data/single_imu/raw"))
    parser.add_argument("--model-out", type=Path, default=Path("models/single_imu/gesture_model.joblib"))
