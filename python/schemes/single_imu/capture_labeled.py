...
from ...common.single_protocol import DEFAULT_BAUD, dataframe_from_records, parse_frame_line, save_recording


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Record labeled gesture trials from the single MPU6050 stream.")
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("data/single_imu/raw"))
...
def main() -> None:
    ...
    with serial.Serial(args.port, args.baud, timeout=1) as ser:
        ...
        print("Keep the sensor still for 2 seconds after reset or after sending recalibration.")
        time.sleep(2.0)
