...
from ...common.triple_protocol import load_recording


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train a hand/thumb/index gesture classifier from labeled CSV trials.")
    parser.add_argument("--data-dir", type=Path, default=Path("data/hand_thumb_index/raw"))
    parser.add_argument("--model-out", type=Path, default=Path("models/hand_thumb_index/gesture_model.joblib"))
