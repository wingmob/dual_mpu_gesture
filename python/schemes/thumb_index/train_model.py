...
from ...common.dual_protocol import load_recording


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train a thumb/index gesture classifier from labeled CSV trials.")
    parser.add_argument("--data-dir", type=Path, default=Path("data/thumb_index/raw"))
    parser.add_argument("--model-out", type=Path, default=Path("models/thumb_index/gesture_model.joblib"))
