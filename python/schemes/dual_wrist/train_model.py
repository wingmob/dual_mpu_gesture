...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--data-dir", type=Path, default=Path("data/dual_wrist/raw"))
    parser.add_argument("--model-out", type=Path, default=Path("models/dual_wrist/gesture_model.joblib"))
