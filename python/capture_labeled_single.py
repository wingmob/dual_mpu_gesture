...
from protocol_single import DEFAULT_BAUD, dataframe_from_records, parse_frame_line, save_recording
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("data/raw_single"))
