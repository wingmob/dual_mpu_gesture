...
from features_single import extract_feature_vector, select_peak_window
from protocol_single import load_recording


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train a single-MPU gesture classifier from labeled CSV trials.")
    parser.add_argument("--data-dir", type=Path, default=Path("data/raw_single"))
    parser.add_argument("--model-out", type=Path, default=Path("models/gesture_model_single.joblib"))
