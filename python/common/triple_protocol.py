...
ACCEL_COLUMNS = [f"{axis}{sensor_idx}" for sensor_idx in range(1, SENSOR_COUNT + 1) for axis in ("ax", "ay", "az")]
GYRO_COLUMNS = [f"{axis}{sensor_idx}" for sensor_idx in range(1, SENSOR_COUNT + 1) for axis in ("gx", "gy", "gz")]
